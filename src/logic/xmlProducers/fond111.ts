...
\t\t<OperationModeCreate>
\t\t\t<OperationModeCode>037</OperationModeCode>
\t\t</OperationModeCreate>
\t\t<CompanyName>
\t\t\t<CompanyNameShort>Dias-fond-${row.cvr}</CompanyNameShort>
\t\t\t<CompanyName1>Dias-fond-${row.cvr}</CompanyName1>
\t\t</CompanyName>
...
\t\t\t\t<TaxationRuleCode>11</TaxationRuleCode>
