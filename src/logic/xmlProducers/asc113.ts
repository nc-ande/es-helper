...
\t\t</OperationModeCreate>
\t\t<CompanyName>
\t\t\t<CompanyNameShort>Dias-forening fbl113-${row.cvr}</CompanyNameShort>
\t\t\t<CompanyName1>Dias-forening fbl113-${row.cvr}</CompanyName1>
\t\t</CompanyName>
...
\t\t\t\t<TaxationRuleCode>13</TaxationRuleCode>
